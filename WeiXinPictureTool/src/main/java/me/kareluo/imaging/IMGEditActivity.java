...
public class IMGEditActivity extends IMGEditBaseActivity {
    ...
    public void onCreated() {
        Log.d("daili IMEEditActivity", "onCreated");
    ...
    public Bitmap getBitmap() {
        ...
        Log.d("daili IMEEditActivity", "uri: " + uri);
        if (uri == null) {
            return null;
        }
        ...
        Log.d("daili IMEEditActivity", "path: " + path);
        ...
        Log.d("daili IMEEditActivity", "decoder: " + decoder);
        if (decoder == null) {
            return null;
        }
